    ...
    <div className="animate-in fade-in duration-700">
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 md:py-20 grid md:grid-cols-2 gap-12 items-center min-h-[70vh]">
        ...
        <div className="space-y-6 md:space-y-8 order-2 md:order-1">
          <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full bg-neutral-900 border border-neutral-800 text-xs font-medium ${AVAILABILITY.status ? 'text-emerald-500' : 'text-neutral-300'}`}>
      ...
      <section className="bg-neutral-900/20 py-16 border-y border-neutral-900">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-6">
          ...
          <div className="text-neutral-300 leading-8 text-lg">
            {ABOUT_TEXT}
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex justify-between items-end mb-8">
            <div>
              ...
              <p className="text-neutral-300">Swipe to explore recent projects.</p>
            </div>
            
            <div className="flex gap-2">
              <button onClick={scrollLeft} className="p-2 rounded-full border border-neutral-800 hover:bg-neutral-800 text-neutral-300 hover:text-white transition-colors">
                <ChevronLeft size={20} />
              </button>
              <button onClick={scrollRight} className="p-2 rounded-full border border-neutral-800 hover:bg-neutral-800 text-neutral-300 hover:text-white transition-colors">
          ...
          >
            ...
            <div className="min-w-[200px] snap-center flex items-center justify-center">
              <Link to="/research" className="group flex flex-col items-center gap-3 text-neutral-300 hover:text-white transition-colors p-8">
      ...
      <section id="cv" className="max-w-4xl mx-auto px-6 py-24">
        ...
        <div className="space-y-16">
          ...
          <div className="flex justify-center pt-8">
            <Link to="/cv" className="inline-flex items-center gap-2 px-6 py-3 border border-neutral-800 rounded-lg text-neutral-300 hover:text-white hover:bg-neutral-900 transition-colors">
